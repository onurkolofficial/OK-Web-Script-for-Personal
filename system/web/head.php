	<head>
		...
		<meta name="author" content="Onur Kol"/>
		<!-- Provide a short description of the page. -->
		<meta name="description" <?php echo 'content="'.LANG_HEAD_DESCRIPTION.'"'; ?>>
		<meta name="keywords" content="web, onur, kol, page">
		...
		<!-- Icon !-->
		<link href="/web/assets/images/favicon.ico" rel="icon" type="image/x-icon">
		<!-- Scripts !-->
		<script src="/assets/js/jquery-3.6.0.min.js"></script>
		<script src="/assets/js/okweb.main.js"></script>
		<script src="/assets/js/search.js"></script>
	</head>
	<div class="pageStartLine"></div>